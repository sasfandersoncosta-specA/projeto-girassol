...
// Esta função global é chamada automaticamente pelo seu admin.js ao carregar a página
window.initializePage = async function() {
    ...
    try {
        ...
        // 1. Atualiza os Números (Média e Total)
        ...
        // 2. Renderiza a Lista de Feedbacks
        ...
        data.reviews.forEach(review => {
            ...
            // Adiciona efeito hover simples via JS (opcional)
        ...
        container.innerHTML = `
            <div style="text-align:center; padding: 20px; color: #d9534f;">
                ...
                <small>Verifique se o servidor está rodando e se a rota /api/admin/feedbacks existe.</small>
            </div>
        `;
    }
};